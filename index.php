...
<html>
    ...
    <body>
        ...
        <div class="categories_grid">
            ...
            <a href="html/games/index.php" class="categories" id="c_gam"><p class="category_text">Games</p></a>
            <a href="html/books/index.php" class="categories" id="c_bok"><p class="category_text">Books</p></a>
            <a href="html/anime/index.php" class="categories" id="c_anm"><p class="category_text">Anime</p></a>
            <a href="html/manga/index.php" class="categories" id="c_mag"><p class="category_text">Manga</p></a>
        </div>
    </body>
</html>
